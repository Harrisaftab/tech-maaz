                    ...
                    <div class="col-12">
                        <div class="footer_upper_big_text sec_padding">
                            <div class="reveal custom_lightSpeedInLeft">
                                <a href="{{ route('contact') }}" class="contact_hover_btn">
                            ...
                            <div class="row align-items-end">
                                ...
                                <div class="col-xl-2 col-lg-2 col-sm-6">
                                    <div class="footer_quick_contact">
                                        ...
                                        <div class="footer_contact">
                                            <a href="tel:+12345678899" class="satoshi_fontfamily line_height_30 fw_500 color_lightgray d-block triners_icons reveal custom_zoom_in">+1 234 567 8899</a>
                                            <a href="tel:+13456789900" class="satoshi_fontfamily line_height_30 fw_500 color_lightgray d-block triners_icons reveal custom_zoom_in">+1 345 678 9900</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-4 col-sm-6">
                                    <div class="footer_gym_time">
                                        ...
                                        <p class="satoshi_fontfamily line_height_30 fw_500 color_lightgray reveal custom_zoom_in">Mon - Fri: 05:00 AM - 10:00 PM</p>
                                        <p class="satoshi_fontfamily line_height_30 fw_500 color_lightgray reveal custom_zoom_in">Sat - Sun: 05:00 AM - 01:00 PM</p>
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-3 col-sm-6">
                                    <div class="footer_address pb-30">
                                        <h6 class="color_white reveal custom_lightSpeedInLeft">WE ARE HERE</h6>
                                        <p class="satoshi_fontfamily line_height_30 fw_500 color_lightgray reveal custom_zoom_in">27 West 24th St New Your, NY 10010</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="footer_bottom_area">
                            <div class="row align-items-center">
                                <div class="col-sm-6">
                                    <p class="satoshi_fontfamily line_height_24 fw_500 color_lightgray reveal custom_zoom_in">Copyright 2024 © Design by <a href="https://1.envato.market/website-portfolio" class="color_lightgray triners_icons" target="_blank">The_Krishna</a></p>
                                </div>
                                <div class="col-sm-6">
                                    <ul class="footer_social_icon">
                                        <li class="reveal custom_zoom_in">
                                            <a href="https://www.facebook.com/" class="triners_icons" target="_blank">
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <mask style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="20" height="20">
                                                    <rect width="20" height="20" fill="white"/>
                                                    </mask>
                                                    <g>
                                                    <path d="M11.6654 11.2498H13.7487L14.582 7.9165H11.6654V6.24984C11.6654 5.39202 11.6654 4.58317 13.332 4.58317H14.582V1.78325C14.3106 1.74721 13.2845 1.6665 12.2011 1.6665C9.93903 1.6665 8.33203 3.04722 8.33203 5.58293V7.9165H5.83203V11.2498H8.33203V18.3332H11.6654V11.2498Z" fill="white"/>
                                                    </g>
                                                </svg>                                                    
                                            </a>
                                        </li>
